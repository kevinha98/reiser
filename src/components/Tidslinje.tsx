...
const TIDSLINJE: ReiseEvent[] = [
  ...
  },
  {
    ...
    undertittel: "Morgentur, marked og middagscruise på Chao Phraya",
    hotellUrl: "https://www.agoda.com/mandarin-hotel-managed-by-centre-point/hotel/bangkok-th.html",
    type: "dag",
    farge: "gold",
    aktiviteter: [
      ...
      {
        type: "fest",
        navn: "Bursdagsmiddag · Unicorn Cruise",
        farge: "#f472b6",
        detaljer: [
          "Avgang ICONSIAM Pier 4 kl. 19:00 — tilbake ca. 21:15",
          "Billettbytte på Pier 4 mellom 17:45 og 18:45",
          "BTS til Saphan Taksin → shuttlebåt fra Sathorn Pier, 12 THB hvert 15.–20. min",
        ],
        bookingUrl: "https://www.ticket2attraction.com/discount-tickets/unicorn-cruise-bangkok/",
        lenkeTekst: "Billett →",
      },
    ],
  },
